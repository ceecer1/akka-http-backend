...
/**
  * https://github.com/spray/spray/blob/master/spray-util/src/main/scala/spray/util/Timestamp.scala
  * @param timestampNanos
  */
private class Timestamp private (val timestampNanos: Long) extends AnyVal {
